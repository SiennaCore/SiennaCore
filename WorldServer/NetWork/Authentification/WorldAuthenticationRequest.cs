...
namespace WorldServer
{
    ...
    public class WorldAuthenticationRequest : ISerializablePacket
    {
        ...
        public override void OnRead(RiftClient From)
        {
            ...
            WorldStartingPosition Position = new WorldStartingPosition();
            Position.MapName = "guardian_map";
            Position.Position.Add(1149965263);
            Position.Position.Add(1147537926);
            Position.Position.Add(1152778324);
            From.SendSerialized(Position);
